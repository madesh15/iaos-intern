...
_register_crud("data-sources", m.BCDDataSourceConnector, DataSourceCreate, DataSourceOut, required_field="source_name")
...
_register_crud("working-papers", m.BCDWorkingPaper, WorkingPaperCreate, WorkingPaperOut, required_field="title")
